...
function BindingInternalApi.join(upstreamBindings)
	...
	local function getValue()
		...
		for key, upstream in next, upstreamBindings do
	...
	function impl.subscribe(callback)
		...
		for key, upstream in next, upstreamBindings do
			disconnects[key] = BindingInternalApi.subscribe(upstream, function()
				callback(getValue())
			end)
		end
		...
		return function()
			...
			for _, disconnect in next, disconnects do
				disconnect()
			end
