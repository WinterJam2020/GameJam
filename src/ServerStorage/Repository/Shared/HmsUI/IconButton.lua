...
ToolTipLabel.Font = Enum.Font.SourceSansSemibold
...
return PseudoInstance:Register("IconButton", {
	WrappedProperties = {
	...
	Internals = {
		"IconLabel", "Rippler", "OutlineImage", "OverlayOpacity", "Shadow", "TooltipObject", "InputBegan", "InputEnded", "InputChanged", "RegisteredRippleInputs";
		...
		Render = function(self)
			...
			if self.Style == Enumeration.ButtonStyle.Contained then
				...
				self.IconLabel.IconColor3 = SecondaryColor3
				...
				self.IconLabel.IconColor3 = PrimaryColor3
				self.Object.ImageColor3 = PrimaryColor3
			end
		end;
	};
	...
	Properties = {
		...
		Icon = Typer.AssignSignature(2, Typer.String, function(self, Icon)
			self.IconLabel.Icon = Icon
			self:Rawset("Icon", Icon)
		end);

		IconColor3 = Typer.AssignSignature(2, Typer.Color3, function(self, IconColor3)
			self.IconLabel.IconColor3 = IconColor3
		...
		IconTransparency = Typer.AssignSignature(2, Typer.NonNegativeNumber, function(self, Transparency)
			self.IconLabel.IconTransparency = Transparency
		...
		Disabled = Typer.AssignSignature(2, Typer.Boolean, function(self, Disabled)
			if self.Disabled ~= Disabled  then
				...
				if Disabled then
					...
					self.IconLabel.IconTransparency = 0.62
					...
					self.IconLabel.IconTransparency = self.IconTransparency
		...
		ZIndex = Typer.AssignSignature(2, Typer.Number, function(self, ZIndex)
			...
			self.IconLabel.ZIndex = ZIndex + 3
	...
	Init = function(self)
		...
		self.IconLabel = PseudoInstance.new("IconLabel")
		self.IconLabel.IconColor3 = Color.Black
		self.IconLabel.Icon = "favorite"
		self.IconLabel.Size = UDim2.fromScale(0.5, 0.5)
		self.IconLabel.AnchorPoint = Vector2.new(0.5, 0.5)
		self.IconLabel.Position = UDim2.fromScale(0.5, 0.5)
		self.IconLabel.Parent = self.Object

		self:Rawset("IconTransparency", 0)
		self:Rawset("Icon", "favorite")
		...
		self.Janitor:Add(self.IconLabel, "Destroy")
