...
local Frame do
	...
	Frame.Name = "ChoiceDialogNoCancel"
...
return PseudoInstance:Register("ChoiceDialogNoDismiss", {
	Storage = table.create(0);
	Internals = {
		"ConfirmButton", "RadioGroup", "AssociatedRadioContainers", "Header", "UIScale", "Background";
		SHOULD_BLUR = true;
	};
