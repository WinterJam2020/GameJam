...
local XboxDark = setmetatable({ClassName = "XboxDark"}, Spritesheet)
XboxDark.__index = XboxDark

function XboxDark.new()
	local self = setmetatable(Spritesheet.new("rbxassetid://408444495"), XboxDark)

	self:AddSprite("ButtonX", Vector2.new(510, 416), Vector2.new(95, 95)) -- 79 tall
	...
	self:AddSprite("Controller", Vector2.new(), Vector2.new(615, 415))
