...
local XboxLight = setmetatable({ClassName = "XboxLight"}, Spritesheet)
XboxLight.__index = XboxLight

function XboxLight.new()
	local self = setmetatable(Spritesheet.new("rbxassetid://408462759"), XboxLight)
