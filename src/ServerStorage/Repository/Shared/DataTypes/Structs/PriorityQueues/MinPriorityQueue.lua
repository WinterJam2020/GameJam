...
--[[**
	...
	@returns [Typer.Array] The MinPriorityQueue's array.
**--]]
...
--[[**
	...
	@returns [Typer.Function] The iterator function. Usage is `for Index, Value in MinPriorityQueue:Iterate(OnlyValues) do`.
**--]]
...
--[[**
	...
	@param [Typer.OptionalBoolean] OnlyValues Whether or not the iterator returns just the values or the priorities as well.
	@returns [Typer.Function] The iterator function. Usage is `for Index, Value in MinPriorityQueue:ReverseIterate(OnlyValues) do`.
**--]]
...
--[[**
	...
	@returns [MinPriorityQueue] The priority queue.
**--]]
