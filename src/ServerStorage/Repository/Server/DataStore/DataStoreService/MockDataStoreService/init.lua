...
function MockDataStoreService.GetRequestBudgetForRequestType(_, requestType) -- luacheck: ignore self
...
function MockDataStoreService.ImportFromJSON(_, json, verbose) -- luacheck: ignore self
	local content
