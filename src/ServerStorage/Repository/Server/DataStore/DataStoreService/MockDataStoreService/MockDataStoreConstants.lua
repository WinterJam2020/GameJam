...
return {
	...
	WRITE_COOLDOWN = 6;           -- Amount of cooldown time between writes on the same key in a particular datastore

	GET_COOLDOWN = 5;             -- Amount of cooldown time that a recent interaction with a key is considered fresh
	...
	BUDGET_UPDATE_INTERVAL = 1;   -- Time interval in seconds at which budgets are updated (do not put too low)
}
